...
$(document).ready(function () {
  ...
  $('.delete_notif').click(function (event) {
    var notification_mess = $(this).closest('.notification_message');
    ...
    setTimeout(function () {
      ...
      if (header_admin.find('.notification_message').length === 0) {
        ...
        $('.show_triangle').addClass('none');
      } else {// console.log(header_admin.find('.notification_message'))
      }
    }, 300);
  });
  ...
  $('.tab_section_tab_title').click(function (event) {
    ...
    var data_index = $(this).attr('data-index-selected');
    var $fields = $(this).closest('.tab_section').find('.fields');
    $fields.find('.section_tab_field').removeClass('active'); // setTimeout(function () {
    //     }, 300);
  ...
  function set_attr_repeat(this_) {
    ...
    $items.each(function (index) {
      ...
      $element.each(function (index2) {
        ...
        if ((typeof $find_base_name === "undefined" ? "undefined" : _typeof($find_base_name)) === ( true ? "undefined" : 0) || $find_base_name === false) {
      ...
      var $repeater = $(this).children('.repeater');
      $repeater.each(function (index2) {
  ...
  function js_open_file_popup(event) {
    ...
    var indexBtnPopup = $(this).attr('data-popup');
  ...
  $('.js-save-popup-file').click(function () {
    ...
    $.ajax({
      ...
      success: function success(data) {
        ...
        elem.removeClass('animate-bg-popup');
        elem.addClass('animate-bg-popup-close');
        clear_selected_file(); // disable_selected_file();
      },
  ...
  function get_id_selected_file() {
    var $items = $('.uploaded_files').children('.selected-file');
...
/******/ 	__webpack_require__.O(undefined, ["css/style","css/login"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/style","css/login"], () => (__webpack_require__("./resources/css/login.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/style","css/login"], () => (__webpack_require__("./resources/css/style.scss")))
