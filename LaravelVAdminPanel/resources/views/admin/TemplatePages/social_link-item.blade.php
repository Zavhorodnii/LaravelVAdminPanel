...
{{--            </div>--}}
        ...
        <div class="field_section_container">
            ...
            <div class="repeater border_top padding_10" data-id="repeater-social" name="repeater-social">
                <div class="title_section">
                    Соц сети
                </div>
                <div class="content_repeater">

                    @if(isset($fields['repeater-social']))
                        @foreach( $fields['repeater-social'] as $repeater_social_key => $repeater_social_value )
                                ...
                                <div class="content_item">
                                    ...
                                    <div class="section_input required field border_top padding_10 js_find_elem">
                                        ...
                                        <input class="style_input_field js_paste_name"
                                               ...
                                               data-base_name="link"
                                               name="repeater-social_{{$repeater_social_key}}_link"
                                               value="{{ $repeater_social_value['link'] ?? '' }}"
                                        >
                                    </div>
                                    <div class="image field required border_top padding_10 js_find_elem">
                                        <div class="title_section">
                                            Иконка<span>*</span></div>
                                        <button class="choice js-open-file-popup style_button @if($repeater_social_value['file-id']['status'] == 'ok') none @endif"
                                                type="file" data-popup="show-popup">Выбрать
                                        </button>
                                        <div class="image_section @if($repeater_social_value['file-id']['status'] == 'error') none @endif">
                                            <img class="selected_image js_paste_name js-paste-selected-file"
                                                 name="repeater-social_{{ $repeater_social_key }}_file-id" data-type-filed="imageField"
                                                 data-base_name="file-id"
                                                 src="@if($repeater_social_value['file-id']['status'] == 'ok') {{ $repeater_social_value['file-id']['url'] }} @endif"
                                                 alt="" data-id="@if($repeater_social_value['file-id']['status'] == 'ok') {{ $repeater_social_value['file-id']['id'] }} @endif">
        ...
        <div class="hide-content-repeater none">
            <div class="repeater-fields">
                <div data-id="repeater-social-fields">
                    <div class="content_section repeater_style">
                        <div class="count_item">
                            1
                        </div>
