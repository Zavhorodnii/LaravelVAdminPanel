...
@section('all-delivery-price-submeny-all')
    active
@endsection
                    ...
                    <ul>
                        ...
                        @foreach( $blocks as $block)
                            <li class="single-page js-delete-item border_top padding_10">
                                <div class="main_info">
                                    <div class="title">
                                        <a href="{{ route('update-delivery-price-item', $block->id) }}" class="title_section">
                                            {{ $block->title }}
                                        </a>
                                    </div>
                                    <div class="control">
                                        <a href="{{ route('update-delivery-price-item', $block->id) }}" class="edit-page">Редактировать</a>
        ...
        <div class="field_section">
            ...
            <div class="field_section_container">
                <div class="field_section_container_button border_top padding_10">
                    <a href="{{ route('create-delivery-price-item') }}" class="create aside-style-button style_button add-new-page">
                        Добавить запись
                    </a>
                </div>
            </div>
...
@section('ajaxUrl')
    <script>
        window.ajax_delete_post = '{{ route('delete-delivery-price') }}';
        window.ajax_change_draft_status = '{{ route('change-draft-delivery-controller') }}';
    </script>
@endsection
